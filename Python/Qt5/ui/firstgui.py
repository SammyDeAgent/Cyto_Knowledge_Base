...
class Ui_myfirstgui(object):
    def setupUi(self, myfirstgui):
        ...
        self.buttonBox.accepted.connect(myfirstgui.accept) # type: ignore
        self.buttonBox.rejected.connect(myfirstgui.reject) # type: ignore
        self.clearBtn.clicked.connect(self.listWidget.clear) # type: ignore
